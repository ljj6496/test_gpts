...
import trading_inquire_period_trans
...
def main():
    ...
    Example:
        >>> df1, df2 = get_trading_inquire_period_trans(cano=trenv.my_acct, acnt_prdt_cd="", erlm_strt_dt="20240420", erlm_end_dt="20240520", ovrs_excg_cd="", pdno="", sll_buy_dvsn_cd="00", loan_dvsn_cd="", ctx_area_fk100="", ctx_area_nk100="")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result1, result2 = trading_inquire_period_trans.get_trading_inquire_period_trans(
            cano=cano,  # 종합계좌번호
