...
def main():
    ...
    Example:
        >>> df = post_trading_order(cano=trenv.my_acct, acnt_prdt_cd="01", ovrs_excg_cd="NASD", pdno="AAPL", ord_qty="10", ovrs_ord_unpr="150.00", ord_dv="sell", ctac_tlno="", mgco_aptm_odno="", ord_svr_dvsn_cd="0", ord_dvsn="00", env_dv="real")  # 실전투자
        >>> df = post_trading_order(cano=trenv.my_acct, acnt_prdt_cd="01", ovrs_excg_cd="NASD", pdno="AAPL", ord_qty="10", ovrs_ord_unpr="150.00", ord_dv="sell", ctac_tlno="", mgco_aptm_odno="", ord_svr_dvsn_cd="0", ord_dvsn="00", env_dv="demo")  # 모의투자
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = trading_order.post_trading_order(
            cano=cano,  # 종합계좌번호
