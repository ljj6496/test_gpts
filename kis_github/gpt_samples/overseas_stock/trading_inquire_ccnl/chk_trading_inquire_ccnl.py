...
def main():
    ...
    Example:
        >>> df = get_trading_inquire_ccnl(cano=trenv.my_acct, acnt_prdt_cd="01", pdno="", ord_strt_dt="20250101", ord_end_dt="20250131", sll_buy_dvsn="00", ccld_nccs_dvsn="00", ovrs_excg_cd="", sort_sqn="DS", ord_dt="", ord_gno_brno="", odno="", ctx_area_nk200="", ctx_area_fk200="", env_dv="real")  # 실전투자
        >>> df = get_trading_inquire_ccnl(cano=trenv.my_acct, acnt_prdt_cd="01", pdno="", ord_strt_dt="20250101", ord_end_dt="20250131", sll_buy_dvsn="00", ccld_nccs_dvsn="00", ovrs_excg_cd="", sort_sqn="DS", ord_dt="", ord_gno_brno="", odno="", ctx_area_nk200="", ctx_area_fk200="", env_dv="demo")  # 모의투자
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = trading_inquire_ccnl.get_trading_inquire_ccnl(
            cano=cano,  # 종합계좌번호
