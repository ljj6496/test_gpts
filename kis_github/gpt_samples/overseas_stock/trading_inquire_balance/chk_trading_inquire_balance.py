...
import trading_inquire_balance
...
def main():
    ...
    Example:
        >>> df1, df2 = get_trading_inquire_balance(cano=trenv.my_acct, acnt_prdt_cd="01", ovrs_excg_cd="NASD", tr_crcy_cd="USD", ctx_area_fk200="", ctx_area_nk200="", env_dv="real")  # 실전투자
        >>> df1, df2 = get_trading_inquire_balance(cano=trenv.my_acct, acnt_prdt_cd="01", ovrs_excg_cd="NASD", tr_crcy_cd="USD", ctx_area_fk200="", ctx_area_nk200="", env_dv="demo")  # 모의투자
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result1, result2 = trading_inquire_balance.get_trading_inquire_balance(
            cano=cano,  # 종합계좌번호
