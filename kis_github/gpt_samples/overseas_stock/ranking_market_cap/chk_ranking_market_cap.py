...
from ranking_market_cap import get_ranking_market_cap
...
def main():
    """
    해외주식 시가총액순위 조회 테스트 함수
    
    이 함수는 해외주식 시가총액순위 API를 호출하여 결과를 출력합니다.
    ...
    try:
        result1, result2 = get_ranking_market_cap(excd="SZS", vol_rang="1")
