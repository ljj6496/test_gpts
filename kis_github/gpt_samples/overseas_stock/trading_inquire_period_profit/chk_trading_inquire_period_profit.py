...
import trading_inquire_period_profit
...
def main():
    ...
    Example:
        >>> df1, df2 = get_trading_inquire_period_profit(cano=trenv.my_acct, acnt_prdt_cd="01", ovrs_excg_cd="", natn_cd="", crcy_cd="", pdno="", inqr_strt_dt="20250101", inqr_end_dt="20250131", wcrc_frcr_dvsn_cd="01", ctx_area_fk200="", ctx_area_nk200="")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result1, result2 = trading_inquire_period_profit.get_trading_inquire_period_profit(
            cano=cano,  # 종합계좌번호
