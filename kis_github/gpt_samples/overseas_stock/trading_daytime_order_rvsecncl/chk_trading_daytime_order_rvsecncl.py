...
import trading_daytime_order_rvsecncl
...
def main():
    ...
    Example:
        >>> df = post_trading_daytime_order_rvsecncl(cano=trenv.my_acct, acnt_prdt_cd="01", ovrs_excg_cd="NASD", pdno="AAPL", orgn_odno="1234567890", rvse_cncl_dvsn_cd="01", ord_qty="10", ovrs_ord_unpr="150.25", ctac_tlno="", mgco_aptm_odno="", ord_svr_dvsn_cd="0")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        # API 호출
        logger.info("API 호출 시작: 해외주식 미국주간정정취소")
        result = trading_daytime_order_rvsecncl.post_trading_daytime_order_rvsecncl(
            cano=cano,  # 종합계좌번호
