...
def main():
    ...
    Example:
        >>> df = post_trading_daytime_order(cano=trenv.my_acct, acnt_prdt_cd="01", ovrs_excg_cd="NASD", pdno="AAPL", ord_qty="10", ovrs_ord_unpr="150.50", ctac_tlno="", mgco_aptm_odno="", ord_svr_dvsn_cd="0", ord_dvsn="00")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = trading_daytime_order.post_trading_daytime_order(
