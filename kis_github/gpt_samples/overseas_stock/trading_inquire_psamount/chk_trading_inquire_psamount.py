...
def main():
    ...
    Example:
        >>> df = get_trading_inquire_psamount(cano=trenv.my_acct, acnt_prdt_cd="01", ovrs_excg_cd="NASD", ovrs_ord_unpr="1.4", item_cd="QQQ", env_dv="real")  # 실전투자
        >>> df = get_trading_inquire_psamount(cano=trenv.my_acct, acnt_prdt_cd="01", ovrs_excg_cd="NASD", ovrs_ord_unpr="1.4", item_cd="QQQ", env_dv="demo")  # 모의투자
    """
    try:
        # pandas 출력 옵션 설정
