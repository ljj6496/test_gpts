...
def get_trading_order_resv_ccnl(
    ...
    * 해외주식 서비스 신청 후 이용 가능합니다. (아래 링크 3번 해외증권 거래신청 참고)
    ...
    Example:
        >>> df = get_trading_order_resv_ccnl(env_dv="real", nat_dv="us", cano="81180744", acnt_prdt_cd="01", rsyn_ord_rcit_dt="20220810", ovrs_rsvn_odno="0030008244")
        >>> print(df)
    """
