...
def main():
    ...
    Example:
        >>> df = get_trading_inquire_nccs(cano=trenv.my_acct, acnt_prdt_cd="01", ovrs_excg_cd="", sort_sqn="DS", ctx_area_fk200="", ctx_area_nk200="")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = trading_inquire_nccs.get_trading_inquire_nccs(
            cano=cano,  # 종합계좌번호
