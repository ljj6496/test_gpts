...
from ranking_trade_growth import get_ranking_trade_growth
...
def main():
    """
    해외주식 거래증가율순위 조회 테스트 함수
    
    이 함수는 해외주식 거래증가율순위 API를 호출하여 결과를 출력합니다.
    ...
    try:
        result1, result2 = get_ranking_trade_growth(excd="NAS", nday="0", vol_rang="0")
