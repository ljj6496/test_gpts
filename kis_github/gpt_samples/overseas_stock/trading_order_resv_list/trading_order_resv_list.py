...
def get_trading_order_resv_list(
    nat_dv: str,  # 국가구분코드
    cano: str,  # 종합계좌번호
    ...
    * 해외주식 서비스 신청 후 이용 가능합니다. (아래 링크 3번 해외증권 거래신청 참고)
    ...
    Example:
        >>> df = get_trading_order_resv_list(nat_dv="us", cano="12345678", acnt_prdt_cd="01", inqr_strt_dt="20250101", inqr_end_dt="20251231", inqr_dvsn_cd="00", ovrs_excg_cd="NASD")
        >>> print(df)
    """
    ...
    if res.isOK():
        ...
        if tr_cont in ["M", "F"]:  # 다음 페이지 존재
            ...
            return get_trading_order_resv_list(
