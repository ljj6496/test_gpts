...
from trading_order_resv_list import get_trading_order_resv_list
...
def main():
    ...
    try:
        result = get_trading_order_resv_list(nat_dv="us", cano="81180744", acnt_prdt_cd="01", inqr_strt_dt="20220809", inqr_end_dt="20220830", inqr_dvsn_cd="00", ovrs_excg_cd="NASD")
