...
import quotations_search_bond_info
...
def main():
    ...
    Example:
        >>> df = get_quotations_search_bond_info(pdno="", prdt_type_cd="302")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = quotations_search_bond_info.get_quotations_search_bond_info(
            pdno=pdno,  # 상품번호
