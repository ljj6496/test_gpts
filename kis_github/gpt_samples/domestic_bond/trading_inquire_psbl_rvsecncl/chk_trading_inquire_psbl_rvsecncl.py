...
import trading_inquire_psbl_rvsecncl
...
def main():
    ...
    Example:
        >>> df = get_trading_inquire_psbl_rvsecncl(cano="1234567890", acnt_prdt_cd="01", ord_dt="20250601", odno="", ctx_area_fk200="", ctx_area_nk200="")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = trading_inquire_psbl_rvsecncl.get_trading_inquire_psbl_rvsecncl(
            cano=cano,  # 종합계좌번호
