...
import quotations_inquire_asking_price
...
def main():
    ...
    Example:
        >>> df = get_quotations_inquire_asking_price(fid_cond_mrkt_div_code="B", fid_input_iscd="KR2033022D33")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = quotations_inquire_asking_price.get_quotations_inquire_asking_price(
