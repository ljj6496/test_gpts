...
def main():
    ...
    Example:
        >>> df1, df2, df3 = get_quotations_avg_unit(inqr_strt_dt="20250101", inqr_end_dt="20250131", pdno="KR2033022D33", prdt_type_cd="302", vrfc_kind_cd="00", ctx_area_nk30="", ctx_area_fk100="")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result1, result2, result3 = quotations_avg_unit.get_quotations_avg_unit(
