...
import quotations_inquire_daily_itemchartprice
...
def main():
    ...
    Example:
        >>> df = get_quotations_inquire_daily_itemchartprice(fid_cond_mrkt_div_code="B", fid_input_iscd="KR2033022D33")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = quotations_inquire_daily_itemchartprice.get_quotations_inquire_daily_itemchartprice(
