...
def get_quotations_inquire_daily_itemchartprice(
    ...
    Example:
        >>> df = get_quotations_inquire_daily_itemchartprice("B", "KR2033022D33")
        >>> print(df)
    """
    # 필수 파라미터 검증
    ...
    if res.isOK():
        ...
        if tr_cont == "M":
            ...
            time.sleep(0.1)
            return get_quotations_inquire_daily_itemchartprice(
