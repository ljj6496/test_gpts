...
import trading_inquire_daily_ccld
...
def main():
    ...
    Example:
        >>> df1, df2 = trading_inquire_daily_ccld.get_trading_inquire_daily_ccld(cano="12345678", acnt_prdt_cd="01", inqr_strt_dt="20250601", inqr_end_dt="20250630", sll_buy_dvsn_cd="%", sort_sqn_dvsn="01", pdno="", nccs_yn="N", ctx_area_nk200="", ctx_area_fk200="")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result1, result2 = trading_inquire_daily_ccld.get_trading_inquire_daily_ccld(
            cano=cano,  # 종합계좌번호
