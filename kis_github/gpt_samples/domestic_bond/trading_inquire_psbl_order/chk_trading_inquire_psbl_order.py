...
import trading_inquire_psbl_order
...
def main():
    ...
    Example:
        >>> df = get_trading_inquire_psbl_order(cano="1234567890", acnt_prdt_cd="01", pdno="KR2033022D33", bond_ord_unpr="1000")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = trading_inquire_psbl_order.get_trading_inquire_psbl_order(
            cano=cano,  # 종합계좌번호
