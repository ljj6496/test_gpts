...
from quotations_display_board_callput import get_quotations_display_board_callput
...
def main():
    ...
    try:
        result1, result2 = get_quotations_display_board_callput(
    ...
    # 컬럼명 한글 변환 및 데이터 출력 (output2도 동일한 구조)
    column_mapping2 = {
        'acpr': '행사가',
        'unch_prpr': '환산 현재가',
        'optn_shrn_iscd': '옵션 단축 종목코드',
