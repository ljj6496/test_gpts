...
def get_quotations_display_board_callput(
    ...
    fid_mtrt_cnt: str,            # [필수] 만기 수 (ex. 202407)
    ...
    Example:
        >>> df1, df2 = get_quotations_display_board_callput("O", "20503", "CO", "202407", "PO")
        >>> print(df1)
        >>> print(df2)
    """
    ...
    if fid_mtrt_cnt == "":
        raise ValueError("fid_mtrt_cnt is required (e.g. '202407')")
