...
from trading_ngt_margin_detail import get_trading_ngt_margin_detail
...
def main():
    ...
    try:
        result1, result2, result3 = get_trading_ngt_margin_detail(cano="81180744", acnt_prdt_cd="03", mgna_dvsn_cd="01")
