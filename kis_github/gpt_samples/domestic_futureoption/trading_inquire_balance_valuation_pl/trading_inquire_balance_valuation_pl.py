...
def get_trading_inquire_balance_valuation_pl(
    ...
    Example:
        >>> df1, df2 = get_trading_inquire_balance_valuation_pl(cano="81180744", acnt_prdt_cd="03", mgna_dvsn="01", excc_stat_cd="1")
        >>> print(df1)
        >>> print(df2)
    """
    ...
    if res.isOK():
        ...
        if tr_cont in ["M", "F"]:  # 다음 페이지 존재
            ...
            return get_trading_inquire_balance_valuation_pl(
                cano, acnt_prdt_cd, mgna_dvsn, excc_stat_cd, FK200, NK200, "N", dataframe1, dataframe2, depth + 1, max_depth
            )
        else:
