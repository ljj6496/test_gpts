...
from trading_inquire_balance_valuation_pl import get_trading_inquire_balance_valuation_pl
...
def main():
    ...
    try:
        result1, result2 = get_trading_inquire_balance_valuation_pl(cano="81180744", acnt_prdt_cd="03", mgna_dvsn="01", excc_stat_cd="1")
