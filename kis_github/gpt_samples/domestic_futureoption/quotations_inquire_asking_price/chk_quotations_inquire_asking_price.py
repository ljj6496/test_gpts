...
from quotations_inquire_asking_price import get_quotations_inquire_asking_price
...
def main():
    ...
    try:
        result1, result2 = get_quotations_inquire_asking_price(fid_cond_mrkt_div_code="F", fid_input_iscd="101S03", env_dv="real")
