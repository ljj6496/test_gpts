...
from quotation_stock_option_asking_price import quotation_stock_option_asking_price
...
def main():
    ...
    # 조회
    kws.subscribe(request=quotation_stock_option_asking_price, data=["239W08090"])
    ...
    def on_result(ws, tr_id: str, result: pd.DataFrame, data_map: dict):
        ...
        # 메타데이터에 자료형이 명시적으로 'number'로 선언된 필드가 없으므로 빈 리스트
        numeric_columns = []
