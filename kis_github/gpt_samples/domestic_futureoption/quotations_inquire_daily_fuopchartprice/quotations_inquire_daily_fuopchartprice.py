...
def get_quotations_inquire_daily_fuopchartprice(
    ...
    Args:
        ...
        fid_input_iscd (str): [필수] 종목코드 (ex. 101S09)
    ...
    Example:
        >>> output1, output2 = get_quotations_inquire_daily_fuopchartprice(
    ...
    if fid_input_iscd == "":
        raise ValueError("fid_input_iscd is required (e.g. '101S09')")
    
    if fid_input_date_1 == "":
        raise ValueError("fid_input_date_1 is required (e.g. '20220301')")
    
    if fid_input_date_2 == "":
        raise ValueError("fid_input_date_2 is required (e.g. '20220810')")
