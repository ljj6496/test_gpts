...
def get_trading_inquire_ccnl(
    ...
    Example:
        >>> df1, df2 = get_trading_inquire_ccnl(env_dv="real", cano="81180744", acnt_prdt_cd="03", strt_ord_dt="20220730", end_ord_dt="20220830", sll_buy_dvsn_cd="00", ccld_nccs_dvsn="00", sort_sqn="DS")
        >>> print(df1)
        >>> print(df2)
    """
    ...
    if res.isOK():
        ...
        if tr_cont in ["M", "F"]:  # 다음 페이지 존재
            ...
            return get_trading_inquire_ccnl(
