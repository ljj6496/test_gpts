...
from trading_inquire_balance import get_trading_inquire_balance
...
def main():
    ...
    try:
        result1, result2 = get_trading_inquire_balance(env_dv="real", cano="81180744", acnt_prdt_cd="03", mgna_dvsn="01", excc_stat_cd="1")
