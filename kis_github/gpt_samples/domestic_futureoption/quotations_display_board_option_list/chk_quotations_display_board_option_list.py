...
from quotations_display_board_option_list import get_quotations_display_board_option_list
...
def main():
    ...
    try:
        result = get_quotations_display_board_option_list(fid_cond_scr_div_code="509")
