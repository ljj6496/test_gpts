...
def get_trading_inquire_psbl_ngt_order(
    cano: str,                 # 종합계좌번호
    ...
    Example:
        >>> df = get_trading_inquire_psbl_ngt_order(cano="81180744", acnt_prdt_cd="03", pdno="101T03", prdt_type_cd="301", sll_buy_dvsn_cd="02", unit_price="322", ord_dvsn_cd="01")
        >>> print(df)
    """
