...
from quotations_exp_price_trend import get_quotations_exp_price_trend
...
def main():
    ...
    try:
        result1, result2 = get_quotations_exp_price_trend(fid_input_iscd="101V06", fid_cond_mrkt_div_code="F")
