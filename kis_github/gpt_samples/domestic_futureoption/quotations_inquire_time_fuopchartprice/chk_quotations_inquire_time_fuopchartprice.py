...
from quotations_inquire_time_fuopchartprice import get_quotations_inquire_time_fuopchartprice
...
def main():
    ...
    try:
        result1, result2 = get_quotations_inquire_time_fuopchartprice(
