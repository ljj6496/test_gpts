...
def get_trading_inquire_ccnl_bstime(
    cano: str,  # [필수] 종합계좌번호
    ...
    Example:
        >>> df1, df2 = get_trading_inquire_ccnl_bstime(cano="81180744", acnt_prdt_cd="03", ord_dt="20230920", fuop_tr_strt_tmd="000000", fuop_tr_end_tmd="240000")
        >>> print(df1)
        >>> print(df2)
    """
    ...
    if res.isOK():
        ...
        if tr_cont in ["M", "F"]:  # 다음 페이지 존재
            ...
            return get_trading_inquire_ccnl_bstime(
