...
from trading_inquire_ngt_ccnl import get_trading_inquire_ngt_ccnl
...
def main():
    ...
    try:
        result1, result2 = get_trading_inquire_ngt_ccnl(cano="81180744", acnt_prdt_cd="03", strt_ord_dt="20250610", end_ord_dt="20250613", sll_buy_dvsn_cd="00", ccld_nccs_dvsn="00")
