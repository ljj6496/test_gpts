...
from quotations_display_board_top import get_quotations_display_board_top
...
def main():
    ...
    try:
        output1, output2 = get_quotations_display_board_top(fid_cond_mrkt_div_code="F", fid_input_iscd="101V06")
