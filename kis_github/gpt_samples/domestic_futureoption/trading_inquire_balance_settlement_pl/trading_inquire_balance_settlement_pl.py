...
def get_trading_inquire_balance_settlement_pl(
    cano: str,  # 종합계좌번호
    ...
    Example:
        >>> df1, df2 = get_trading_inquire_balance_settlement_pl(cano="81180744", acnt_prdt_cd="03", inqr_dt="20230906")
        >>> print(df1)
        >>> print(df2)
    """
    ...
    if res.isOK():
        ...
        if tr_cont in ["M", "F"]:  # 다음 페이지 존재
            ...
            return get_trading_inquire_balance_settlement_pl(
