...
from trading_inquire_balance_settlement_pl import get_trading_inquire_balance_settlement_pl
...
def main():
    ...
    logging.info("=== Case 1 ===")
    try:
        result1, result2 = get_trading_inquire_balance_settlement_pl(cano="81180744", acnt_prdt_cd="03", inqr_dt="20230906")
