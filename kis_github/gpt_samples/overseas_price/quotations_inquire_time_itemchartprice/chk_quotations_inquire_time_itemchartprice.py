...
import quotations_inquire_time_itemchartprice
...
def main():
    ...
    Example:
        >>> df1, df2 = get_quotations_inquire_time_itemchartprice(auth="", excd="NAS", symb="TSLA", nmin="5", pinc="1", next="", nrec="120", fill="", keyb="")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result1, result2 = quotations_inquire_time_itemchartprice.get_quotations_inquire_time_itemchartprice(
            auth=auth,  # 사용자권한정보
            excd=excd,  # 거래소코드
            symb=symb,  # 종목코드
            nmin=nmin,  # 분갭
