...
def main():
    ...
    Example:
        >>> df1, df2, df3 = get_quotations_inquire_asking_price(auth="", excd="NYS", symb="TSLA")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result1, result2, result3 = quotations_inquire_asking_price.get_quotations_inquire_asking_price(
            auth=auth,  # 사용자권한정보
            excd=excd,  # 거래소코드
            symb=symb,  # 종목코드
        )
