...
def get_quotation_colable_by_company(
    pdno: str,  # 상품번호
    natn_cd: str,  # 국가코드
    ...
    Example:
        >>> df1, df2 = get_quotation_colable_by_company(pdno="AMD", natn_cd="840", inqr_sqn_dvsn="01")
    ...
    if res.isOK():
        ...
        if tr_cont in ["M", "F"]:  # 다음 페이지 존재
            ...
            return get_quotation_colable_by_company(
