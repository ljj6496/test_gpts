...
from quotation_colable_by_company import get_quotation_colable_by_company
...
def main():
    ...
    try:
        result1, result2 = get_quotation_colable_by_company(pdno="AMD", natn_cd="840", inqr_sqn_dvsn="01")
