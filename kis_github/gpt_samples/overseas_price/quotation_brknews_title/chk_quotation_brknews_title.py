...
from quotation_brknews_title import get_quotation_brknews_title
...
def main():
    ...
    try:
        result = get_quotation_brknews_title(fid_news_ofer_entp_code="0", fid_cond_scr_div_code="11801")
