...
import quotations_inquire_search
...
def main():
    ...
    Example:
        >>> df1, df2 = get_quotations_inquire_search(auth="", excd="NYS", co_yn_pricecur="1", co_st_pricecur="100", co_en_pricecur="200", co_yn_rate="1", co_st_rate="5", co_en_rate="10", co_yn_valx="1", co_st_valx="1000", co_en_valx="5000", co_yn_shar="1", co_st_shar="100", co_en_shar="500", co_yn_volume="1", co_st_volume="1000", co_en_volume="5000", co_yn_amt="1", co_st_amt="1000", co_en_amt="5000", co_yn_eps="1", co_st_eps="1", co_en_eps="5", co_yn_per="1", co_st_per="10", co_en_per="20", keyb="")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result1, result2 = quotations_inquire_search.get_quotations_inquire_search(
            auth=auth,  # 사용자권한정보
            excd=excd,  # 거래소코드
