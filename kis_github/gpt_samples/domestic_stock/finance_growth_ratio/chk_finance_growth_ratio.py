...
def main():
    ...
    Example:
        >>> df = get_finance_growth_ratio(fid_input_iscd="000660", fid_div_cls_code="0", fid_cond_mrkt_div_code="J")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = finance_growth_ratio.get_finance_growth_ratio(
