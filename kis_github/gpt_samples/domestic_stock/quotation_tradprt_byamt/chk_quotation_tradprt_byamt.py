...
from quotation_tradprt_byamt import get_quotation_tradprt_byamt
...
def main():
    ...
    try:
        result = get_quotation_tradprt_byamt(fid_cond_mrkt_div_code="J", fid_cond_scr_div_code="11119", fid_input_iscd="005930")
