...
from quotation_inquire_daily_price import get_quotation_inquire_daily_price
...
def main():
    ...
    try:
        result = get_quotation_inquire_daily_price(env_dv="real", fid_cond_mrkt_div_code="J", fid_input_iscd="005930", fid_period_div_code="D", fid_org_adj_prc="1")
