...
from quotation_inquire_daily_itemchartprice import get_quotation_inquire_daily_itemchartprice
...
def main():
    ...
    try:
        result1, result2 = get_quotation_inquire_daily_itemchartprice(
            env_dv="real",
