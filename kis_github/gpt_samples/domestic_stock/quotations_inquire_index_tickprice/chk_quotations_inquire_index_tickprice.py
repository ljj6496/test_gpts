...
import quotations_inquire_index_tickprice
...
def main():
    ...
    Example:
        >>> df = get_quotations_inquire_index_tickprice(fid_input_iscd="0001", fid_cond_mrkt_div_code="U")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = quotations_inquire_index_tickprice.get_quotations_inquire_index_tickprice(
