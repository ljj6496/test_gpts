...
def get_quotations_inquire_index_tickprice(
    ...
    Example:
        >>> df = get_quotations_inquire_index_tickprice('0001', 'U')
        >>> print(df)
    """
    # 필수 파라미터 검증
    ...
    if res.isOK():
        ...
        if tr_cont == "M":
            ...
            time.sleep(0.1)
            return get_quotations_inquire_index_tickprice(
                fid_input_iscd,
