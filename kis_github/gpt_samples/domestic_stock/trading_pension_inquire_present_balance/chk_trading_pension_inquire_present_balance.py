...
from trading_pension_inquire_present_balance import get_trading_pension_inquire_present_balance
...
def main():
    ...
    try:
        result1, result2 = get_trading_pension_inquire_present_balance(
            cano="81180744",
            acnt_prdt_cd="29", 
            user_dvsn_cd="00"
        )
    ...
    # 숫자형 컬럼 소수점 둘째자리까지 표시
    numeric_columns = ['매입금액합계금액', '평가금액합계금액', '평가손익합계금액',
                       '매매손익합계', '당일총손익금액', '수익률']
