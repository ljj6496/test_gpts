...
from quotation_inquire_investor import get_quotation_inquire_investor
...
def main():
    ...
    try:
        result = get_quotation_inquire_investor(env_dv="real", fid_cond_mrkt_div_code="J", fid_input_iscd="005930")
