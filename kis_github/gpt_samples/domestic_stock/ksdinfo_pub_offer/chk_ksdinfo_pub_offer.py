...
def main():
    ...
    Example:
        >>> df = get_ksdinfo_pub_offer(sht_cd="", cts="", f_dt="20250101", t_dt="20250131")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        # API 호출
        logger.info("API 호출 시작: 예탁원정보(공모주청약일정)")
        result = ksdinfo_pub_offer.get_ksdinfo_pub_offer(
            sht_cd=sht_cd,  # 종목코드
            cts=cts,  # CTS
            f_dt=f_dt,  # 조회일자From
            t_dt=t_dt,  # 조회일자To
