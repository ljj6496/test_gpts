...
from quotation_inquire_daily_overtimeprice import get_quotation_inquire_daily_overtimeprice
...
def main():
    """
    주식현재가 시간외일자별주가 조회 테스트 함수
    
    이 함수는 주식현재가 시간외일자별주가 API를 호출하여 결과를 출력합니다.
    ...
    try:
        result1, result2 = get_quotation_inquire_daily_overtimeprice(env_dv="real", fid_cond_mrkt_div_code="J", fid_input_iscd="005930")
