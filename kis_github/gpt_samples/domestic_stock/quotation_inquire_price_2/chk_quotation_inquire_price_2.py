...
from quotation_inquire_price_2 import get_quotation_inquire_price_2
...
def main():
    ...
    try:
        result = get_quotation_inquire_price_2(fid_cond_mrkt_div_code="J", fid_input_iscd="005930")
