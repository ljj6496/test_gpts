...
import ranking_after_hour_balance
...
def main():
    ...
    Example:
        >>> df = get_ranking_after_hour_balance(fid_input_price_1="", fid_cond_mrkt_div_code="J", fid_cond_scr_div_code="20176", fid_rank_sort_cls_code="1", fid_div_cls_code="0", fid_input_iscd="0000", fid_trgt_exls_cls_code="0", fid_trgt_cls_code="0", fid_vol_cnt="", fid_input_price_2="")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = ranking_after_hour_balance.get_ranking_after_hour_balance(
