...
def get_quotations_inquire_daily_indexchartprice(
    ...
    Example:
        >>> df1, df2 = get_quotations_inquire_daily_indexchartprice(
    ...
    if res.isOK():
        ...
        if tr_cont in ["M", "F"]:
            ...
            time.sleep(0.1)
            return get_quotations_inquire_daily_indexchartprice(
