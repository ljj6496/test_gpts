...
from quotation_inquire_time_dailychartprice import get_quotation_inquire_time_dailychartprice
...
def main():
    ...
    try:
        result1, result2 = get_quotation_inquire_time_dailychartprice(
