...
from quotation_inquire_member import get_quotation_inquire_member
...
def main():
    ...
    try:
        result = get_quotation_inquire_member(env_dv="real", fid_cond_mrkt_div_code="J", fid_input_iscd="005930")
