...
import quotations_comp_interest
...
def main():
    ...
    Example:
        >>> df1, df2 = get_quotations_comp_interest(fid_cond_mrkt_div_code="I", fid_cond_scr_div_code="20702", fid_div_cls_code="1", fid_div_cls_code1="")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result1, result2 = quotations_comp_interest.get_quotations_comp_interest(
