...
def post_trading_order_resv_rvsecncl(
    cano: str,  # [필수] 종합계좌번호
    ...
    *  정정주문은 취소주문에 비해 필수 입력값이 추가 됩니다. 
    ...
    Example:
        >>> df = post_trading_order_resv_rvsecncl(cano="81180744", acnt_prdt_cd="01", rsvn_ord_seq="88793", rsvn_ord_orgno="123", rsvn_ord_ord_dt="20250113", ord_type="cancel")
        >>> print(df)
    """
