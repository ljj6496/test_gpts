...
def main():
    ...
    Example:
        >>> df = get_quotations_news_title(fid_news_ofer_entp_code="", fid_cond_mrkt_cls_code="", fid_input_iscd="", fid_titl_cntt="", fid_input_date_1="", fid_input_hour_1="", fid_rank_sort_cls_code="", fid_input_srno="")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = quotations_news_title.get_quotations_news_title(
