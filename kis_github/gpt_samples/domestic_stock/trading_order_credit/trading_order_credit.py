...
def post_trading_order_credit(
    ...
    Example:
        >>> df = post_trading_order_credit(ord_dv="buy", cano="12345678", acnt_prdt_cd="01", pdno="005930", crdt_type="21", loan_dt="20220810", ord_dvsn="00", ord_qty="1", ord_unpr="55000")
        >>> print(df)
    """
