...
from quotation_investor_program_trade_today import get_quotation_investor_program_trade_today
...
def main():
    ...
    try:
        result = get_quotation_investor_program_trade_today(mrkt_div_cls_code="1")
