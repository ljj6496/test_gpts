...
import ranking_prefer_disparate_ratio
...
def main():
    ...
    Example:
        >>> df = get_ranking_prefer_disparate_ratio(fid_vol_cnt="1000", fid_cond_mrkt_div_code="J", fid_cond_scr_div_code="20177", fid_div_cls_code="0", fid_input_iscd="0000", fid_trgt_cls_code="0", fid_trgt_exls_cls_code="0", fid_input_price_1="10000", fid_input_price_2="50000")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = ranking_prefer_disparate_ratio.get_ranking_prefer_disparate_ratio(
