...
import ranking_top_interest_stock
...
def main():
    ...
    Example:
        >>> df = get_ranking_top_interest_stock(fid_input_iscd_2="000000", fid_cond_mrkt_div_code="J", fid_cond_scr_div_code="20180", fid_input_iscd="0000", fid_trgt_cls_code="0", fid_trgt_exls_cls_code="0", fid_input_price_1="0", fid_input_price_2="0", fid_vol_cnt="0", fid_div_cls_code="0", fid_input_cnt_1="1")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        # API 호출
        logger.info("API 호출 시작: 국내주식 관심종목등록 상위")
        result = ranking_top_interest_stock.get_ranking_top_interest_stock(
            ...
            fid_input_cnt_1=fid_input_cnt_1,  # 입력 수1
        )
