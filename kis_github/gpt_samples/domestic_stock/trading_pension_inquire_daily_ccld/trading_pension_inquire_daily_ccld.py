...
def get_trading_pension_inquire_daily_ccld(
    ...
    Example:
        >>> df = get_trading_pension_inquire_daily_ccld(cano="81180744", acnt_prdt_cd="29", user_dvsn_cd="%%", sll_buy_dvsn_cd="00", ccld_nccs_dvsn="%%", inqr_dvsn_3="00")
        >>> print(df)
    """
    ...
    if res.isOK():
        ...
        if tr_cont in ["M", "F"]:  # 다음 페이지 존재
            ...
            return get_trading_pension_inquire_daily_ccld(
