...
def main():
    ...
    이 함수는 매수가능조회 API를 호출하여 결과를 출력합니다.
    ...
    try:
        result = get_trading_inquire_psbl_order(env_dv="real", cano="81180744", acnt_prdt_cd="01", pdno="005930", ord_unpr="55000", ord_dvsn="01", cma_evlu_amt_icld_yn="N", ovrs_icld_yn="N")
