...
def get_trading_inquire_psbl_order(
    env_dv: str,  # 실전모의구분
    cano: str,    # 종합계좌번호
    ...
    Example:
        >>> df = get_trading_inquire_psbl_order(env_dv="real", cano="12345678", acnt_prdt_cd="01", pdno="005930", ord_unpr="55000", ord_dvsn="01", cma_evlu_amt_icld_yn="N", ovrs_icld_yn="N")
        >>> print(df)
    """
