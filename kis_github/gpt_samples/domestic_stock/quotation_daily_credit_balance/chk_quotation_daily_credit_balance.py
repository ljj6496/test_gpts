...
from quotation_daily_credit_balance import quotation_daily_credit_balance
...
def main():
    ...
    try:
        result1 = quotation_daily_credit_balance(fid_cond_mrkt_div_code="J", fid_cond_scr_div_code="20476", fid_input_iscd="068270", fid_input_date_1="20240508")
    ...
    try:
        result2 = quotation_daily_credit_balance(fid_cond_mrkt_div_code="J", fid_cond_scr_div_code="20476", fid_input_iscd="068270", fid_input_date_1="20240501")
    except ValueError as e:
        logging.error("에러 발생: %s" % str(e))
        return
