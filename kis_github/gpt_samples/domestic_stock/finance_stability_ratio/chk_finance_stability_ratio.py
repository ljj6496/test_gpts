...
import finance_stability_ratio
...
def main():
    ...
    Example:
        >>> df = get_finance_stability_ratio(fid_input_iscd="000660", fid_div_cls_code="0", fid_cond_mrkt_div_code="J")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        # API 호출
        logger.info("API 호출 시작: 국내주식 안정성비율")
        result = finance_stability_ratio.get_finance_stability_ratio(
