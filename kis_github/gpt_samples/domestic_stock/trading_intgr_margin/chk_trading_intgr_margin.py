...
from trading_intgr_margin import get_trading_intgr_margin
...
def main():
    ...
    try:
        result = get_trading_intgr_margin(cano="81180744", acnt_prdt_cd="01", cma_evlu_amt_icld_yn="N", wcrc_frcr_dvsn_cd="01", fwex_ctrt_frcr_dvsn_cd="01")
