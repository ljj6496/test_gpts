...
def get_trading_period_rights(
    ...
    Example:
        >>> df = get_trading_period_rights(inqr_dvsn="03", cano="12345678", acnt_prdt_cd="01", inqr_strt_dt="20250101", inqr_end_dt="20250103")
        >>> print(df)
    """
    ...
    if res.isOK():
        ...
        if tr_cont in ["M", "F"]:  # 다음 페이지 존재
            ...
            return get_trading_period_rights(
