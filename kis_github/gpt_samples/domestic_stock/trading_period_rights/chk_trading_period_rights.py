...
from trading_period_rights import get_trading_period_rights
...
def main():
    ...
    try:
        result = get_trading_period_rights(inqr_dvsn="03", cano="81180744", acnt_prdt_cd="01", inqr_strt_dt="20250101", inqr_end_dt="20250103")
