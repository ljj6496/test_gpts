...
def main():
    ...
    Example:
        >>> df = get_finance_balance_sheet(fid_div_cls_code="0", fid_cond_mrkt_div_code="J", fid_input_iscd="000660")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        # API 호출
        logger.info("API 호출 시작: 국내주식 대차대조표")
        result = finance_balance_sheet.get_finance_balance_sheet(
