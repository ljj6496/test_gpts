...
import quotations_inquire_index_price
...
def main():
    ...
    Example:
        >>> df = get_quotations_inquire_index_price(fid_cond_mrkt_div_code="U", fid_input_iscd="0001")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        # API 호출
        logger.info("API 호출 시작: 국내업종 현재지수")
        result = quotations_inquire_index_price.get_quotations_inquire_index_price(
