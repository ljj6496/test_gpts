...
def get_trading_inquire_balance_rlz_pl(
    cano: str,  # 종합계좌번호
    ...
    Example:
        >>> df1, df2 = get_trading_inquire_balance_rlz_pl(cano="81180744", acnt_prdt_cd="01", afhr_flpr_yn="N", inqr_dvsn="02", unpr_dvsn="01", fund_sttl_icld_yn="N", fncg_amt_auto_rdpt_yn="N", prcs_dvsn="01")
        >>> print(df1)
        >>> print(df2)
    """
    ...
    if res.isOK():
        ...
        if tr_cont in ["M", "F"]:  # 다음 페이지 존재
            ...
            return get_trading_inquire_balance_rlz_pl(
