...
from quotation_inquire_asking_price_exp_ccn import get_quotation_inquire_asking_price_exp_ccn
...
def main():
    ...
    try:
        result1, result2 = get_quotation_inquire_asking_price_exp_ccn(env_dv="real", fid_cond_mrkt_div_code="J", fid_input_iscd="005930")
