...
from quotation_inquire_time_itemchartprice import get_quotation_inquire_time_itemchartprice
...
def main():
    ...
    try:
        output1, output2 = get_quotation_inquire_time_itemchartprice(env_dv="real", fid_cond_mrkt_div_code="J", fid_input_iscd="005930", fid_input_hour_1="093000", fid_pw_data_incu_yn="Y")
    ...
    output1 = output1.rename(columns=column_mapping1)
    ...
    output2 = output2.rename(columns=column_mapping2)
