...
import quotations_inquire_time_indexchartprice
...
def main():
    ...
    Example:
        >>> df1, df2 = get_quotations_inquire_time_indexchartprice(fid_cond_mrkt_div_code="U", fid_etc_cls_code="0", fid_input_iscd="0001", fid_input_hour_1="60", fid_pw_data_incu_yn="Y")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result1, result2 = quotations_inquire_time_indexchartprice.get_quotations_inquire_time_indexchartprice(
