...
import quotations_inquire_index_daily_price
...
def main():
    ...
    Example:
        >>> df1, df2 = get_quotations_inquire_index_daily_price(fid_period_div_code="D", fid_cond_mrkt_div_code="U", fid_input_iscd="0001", fid_input_date_1="20250101")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        # API 호출
        logger.info("API 호출 시작: 국내업종 일자별지수")
        result1, result2 = quotations_inquire_index_daily_price.get_quotations_inquire_index_daily_price(
