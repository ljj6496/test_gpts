...
def get_quotations_inquire_index_daily_price(
    ...
    Example:
        >>> df1, df2 = get_quotations_inquire_index_daily_price('D', 'U', '0001', '20240223')
        >>> print(df1)
        >>> print(df2)
    """
    # 필수 파라미터 검증
    ...
    if res.isOK():
        ...
        if tr_cont in ["M", "F"]:
            ...
            time.sleep(0.1)
            return get_quotations_inquire_index_daily_price(
                fid_period_div_code,
