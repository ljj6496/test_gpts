...
from quotation_program_trade_by_stock_daily import get_quotation_program_trade_by_stock_daily
...
def main():
    ...
    이 함수는 종목별 프로그램매매추이(일별) API를 호출하여 결과를 출력합니다.
    ...
    try:
        result = get_quotation_program_trade_by_stock_daily(fid_cond_mrkt_div_code="J", fid_input_iscd="005930")
