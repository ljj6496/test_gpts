...
import quotations_invest_opinion
...
def main():
    ...
    Example:
        >>> df = get_quotations_invest_opinion(fid_cond_mrkt_div_code="J", fid_cond_scr_div_code="16633", fid_input_iscd="005930", fid_input_date_1="20231113", fid_input_date_2="20240513")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = quotations_invest_opinion.get_quotations_invest_opinion(
