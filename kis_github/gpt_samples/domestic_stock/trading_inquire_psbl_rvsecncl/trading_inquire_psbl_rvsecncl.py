...
def get_trading_inquire_psbl_rvsecncl(
    cano: str,  # 종합계좌번호
    ...
    Example:
        >>> df = get_trading_inquire_psbl_rvsecncl(cano="81180744", acnt_prdt_cd="01", inqr_dvsn_1="1", inqr_dvsn_2="0")
        >>> print(df)
    """
    ...
    if res.isOK():
        ...
        if tr_cont in ["M", "F"]:  # 다음 페이지 존재
            ...
            return get_trading_inquire_psbl_rvsecncl(
