...
from trading_inquire_psbl_rvsecncl import get_trading_inquire_psbl_rvsecncl
...
def main():
    ...
    try:
        result = get_trading_inquire_psbl_rvsecncl(cano="81180744", acnt_prdt_cd="01", inqr_dvsn_1="1", inqr_dvsn_2="0")
