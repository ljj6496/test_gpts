...
def get_trading_inquire_credit_psamount(
    cano: str,  # 종합계좌번호
    ...
    Example:
        >>> df = get_trading_inquire_credit_psamount(cano="81180744", acnt_prdt_cd="01", pdno="005930", ord_dvsn="00", crdt_type="21", cma_evlu_amt_icld_yn="N", ovrs_icld_yn="N")
        >>> print(df)
    """
