...
def get_trading_inquire_period_profit(
    ...
    Example:
        >>> df1, df2 = get_trading_inquire_period_profit(cano="81180744", acnt_prdt_cd="01", inqr_strt_dt="20230101", inqr_end_dt="20240301", sort_dvsn="00", inqr_dvsn="00", cblc_dvsn="00")
        >>> print(df1)
        >>> print(df2)
    """
    ...
    if res.isOK():
        ...
        if tr_cont in ["M", "F"]:  # 다음 페이지 존재
            ...
            return get_trading_inquire_period_profit(
