...
def main():
    ...
    Example:
        >>> df = get_ranking_volume_power(fid_trgt_exls_cls_code="0", fid_cond_mrkt_div_code="J", fid_cond_scr_div_code="20168", fid_input_iscd="0000", fid_div_cls_code="0", fid_input_price_1="0", fid_input_price_2="1000000", fid_vol_cnt="0", fid_trgt_cls_code="0")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        # API 호출
        logger.info("API 호출 시작: 국내주식 체결강도 상위")
        result = ranking_volume_power.get_ranking_volume_power(
