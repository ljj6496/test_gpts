...
def get_quotations_estimate_perform(
    sht_cd: str,  # 종목코드
    ...
    Example:
        >>> df1, df2, df3, df4 = get_quotations_estimate_perform("265520")
        >>> print(df1)
        >>> print(df2)
    """
    # 필수 파라미터 검증
    ...
    if res.isOK():
        ...
        if hasattr(res.getBody(), 'output3'):
            ...
            if output_data:
                ...
                dataframe3 = pd.concat([dataframe3, current_data3], ignore_index=True) if dataframe3 is not None else current_data3
            else:
        ...
        if hasattr(res.getBody(), 'output4'):
            ...
            if output_data:
                ...
                dataframe4 = pd.concat([dataframe4, current_data4], ignore_index=True) if dataframe4 is not None else current_data4
            else:
        ...
        if tr_cont in ["M", "F"]:
            ...
            time.sleep(0.1)
            return get_quotations_estimate_perform(
