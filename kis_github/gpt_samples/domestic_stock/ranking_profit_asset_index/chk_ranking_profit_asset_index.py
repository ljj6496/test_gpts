...
import ranking_profit_asset_index
...
def main():
    ...
    Example:
        >>> df = get_ranking_profit_asset_index(fid_cond_mrkt_div_code="J", fid_trgt_cls_code="0", fid_cond_scr_div_code="20173", fid_input_iscd="0000", fid_div_cls_code="0", fid_input_price_1="", fid_input_price_2="", fid_vol_cnt="", fid_input_option_1="2023", fid_input_option_2="0", fid_rank_sort_cls_code="0", fid_blng_cls_code="0", fid_trgt_exls_cls_code="0")
    """
    # pandas 출력 옵션 설정
    ...
    # API 호출
    result = ranking_profit_asset_index.get_ranking_profit_asset_index(
