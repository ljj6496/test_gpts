...
import finance_financial_ratio
...
def main():
    ...
    Example:
        >>> df = get_finance_financial_ratio(fid_div_cls_code="0", fid_cond_mrkt_div_code="J", fid_input_iscd="000660")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        # API 호출
        logger.info("API 호출 시작: 국내주식 재무비율")
        result = finance_financial_ratio.get_finance_financial_ratio(
