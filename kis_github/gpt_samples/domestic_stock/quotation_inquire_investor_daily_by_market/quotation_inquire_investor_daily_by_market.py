...
def get_quotation_inquire_investor_daily_by_market(
    fid_cond_mrkt_div_code: str,  # [필수] 조건 시장 분류 코드 (ex. U:업종)
    fid_input_iscd: str,          # [필수] 입력 종목코드 (ex. 0001)
    fid_input_date_1: str,        # [필수] 입력 날짜1 (ex. 20240517)
    ...
    Example:
        >>> df = get_quotation_inquire_investor_daily_by_market("U", "0001", "20240517", "KSP")
        >>> print(df)
    """
    ...
    if fid_input_date_1 == "":
        raise ValueError("fid_input_date_1 is required (e.g. '20240517')")
