...
from quotation_inquire_investor_daily_by_market import get_quotation_inquire_investor_daily_by_market
...
def main():
    ...
    try:
        result = get_quotation_inquire_investor_daily_by_market(
