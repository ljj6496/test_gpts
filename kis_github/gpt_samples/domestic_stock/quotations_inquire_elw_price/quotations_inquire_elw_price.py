...
def get_quotations_inquire_elw_price(
    ...
    Example:
        >>> df = get_quotations_inquire_elw_price('W', '000660', env_dv='real')  # 실전투자
        >>> df = get_quotations_inquire_elw_price('W', '000660', env_dv='demo')  # 모의투자
        >>> print(df)
    """
    # 로깅 설정
    logger = logging.getLogger(__name__)
    ...
    if res.isOK():
        ...
        if tr_cont in ["M", "F"]:
            ...
            time.sleep(0.1)
            return get_quotations_inquire_elw_price(
