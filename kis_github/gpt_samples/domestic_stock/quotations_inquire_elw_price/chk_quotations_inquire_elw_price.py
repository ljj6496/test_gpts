...
import quotations_inquire_elw_price
...
def main():
    ...
    Example:
        >>> df = get_quotations_inquire_elw_price(fid_cond_mrkt_div_code="W", fid_input_iscd="123456", env_dv="real")  # 실전투자
        >>> df = get_quotations_inquire_elw_price(fid_cond_mrkt_div_code="W", fid_input_iscd="123456", env_dv="demo")  # 모의투자
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = quotations_inquire_elw_price.get_quotations_inquire_elw_price(
