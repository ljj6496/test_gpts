...
import quotations_invest_opbysec
...
def main():
    ...
    Example:
        >>> df = get_quotations_invest_opbysec(fid_cond_mrkt_div_code="J", fid_cond_scr_div_code="16634", fid_input_iscd="005930", fid_div_cls_code="0", fid_input_date_1="20250101", fid_input_date_2="20250131")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        # API 호출
        logger.info("API 호출 시작: 국내주식 증권사별 투자의견")
        result = quotations_invest_opbysec.get_quotations_invest_opbysec(
