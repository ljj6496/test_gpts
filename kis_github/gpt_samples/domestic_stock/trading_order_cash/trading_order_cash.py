...
def post_trading_order_cash(
    ...
    Example:
        >>> df = post_trading_order_cash(env_dv="demo", ord_dv="buy", cano="12345678", acnt_prdt_cd="01", pdno="005930", ord_dvsn="00", ord_qty="1", ord_unpr="70000", excg_id_dvsn_cd="KRX")
        >>> print(df)
    """
