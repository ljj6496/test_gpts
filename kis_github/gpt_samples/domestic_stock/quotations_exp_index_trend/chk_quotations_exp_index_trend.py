...
import quotations_exp_index_trend
...
def main():
    ...
    Example:
        >>> df = get_quotations_exp_index_trend(fid_mkop_cls_code="1", fid_input_hour_1="", fid_input_iscd="0001", fid_cond_mrkt_div_code="U")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = quotations_exp_index_trend.get_quotations_exp_index_trend(
