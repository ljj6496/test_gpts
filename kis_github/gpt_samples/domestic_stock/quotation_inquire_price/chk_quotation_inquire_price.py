...
from quotation_inquire_price import get_quotation_inquire_price
...
def main():
    ...
    try:
        result = get_quotation_inquire_price(env_dv="real", fid_cond_mrkt_div_code="J", fid_input_iscd="005930")
