...
from quotation_program_trade_by_stock import get_quotation_program_trade_by_stock
...
def main():
    ...
    try:
        result = get_quotation_program_trade_by_stock(fid_cond_mrkt_div_code="J", fid_input_iscd="005930")
