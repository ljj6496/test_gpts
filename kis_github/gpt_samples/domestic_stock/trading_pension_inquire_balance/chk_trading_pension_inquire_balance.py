...
from trading_pension_inquire_balance import get_trading_pension_inquire_balance
...
def main():
    ...
    try:
        result1, result2 = get_trading_pension_inquire_balance(cano="81180744", acnt_prdt_cd="29", acca_dvsn_cd="00", inqr_dvsn="00")
