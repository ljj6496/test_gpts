...
def get_trading_pension_inquire_balance(
    ...
    Example:
        >>> df1, df2 = get_trading_pension_inquire_balance(cano="12345678", acnt_prdt_cd="29", acca_dvsn_cd="00", inqr_dvsn="00")
        >>> print(df1)
        >>> print(df2)
    """
    ...
    if res.isOK():
        ...
        if tr_cont in ["M", "F"]:  # 다음 페이지 존재
            ...
            return get_trading_pension_inquire_balance(
