...
def main():
    ...
    Parameters:
        ...
        - cts (str): CTS (공백)
    Returns:
        - DataFrame: 예탁원정보(실권주일정) 결과
    
    Example:
        >>> df = get_ksdinfo_forfeit(sht_cd="", t_dt="20250131", f_dt="20250101", cts="")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = ksdinfo_forfeit.get_ksdinfo_forfeit(
            sht_cd=sht_cd,  # 종목코드
            t_dt=t_dt,  # 조회일자To
            f_dt=f_dt,  # 조회일자From
            cts=cts,  # CTS
