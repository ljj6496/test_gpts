...
import quotations_search_stock_info
...
def main():
    ...
    Example:
        >>> df = get_quotations_search_stock_info(prdt_type_cd="", pdno="005930")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        # API 호출
        logger.info("API 호출 시작: 주식기본조회")
        result = quotations_search_stock_info.get_quotations_search_stock_info(
