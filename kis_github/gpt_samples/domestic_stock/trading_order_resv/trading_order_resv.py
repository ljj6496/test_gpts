...
def post_trading_order_resv(
    ...
    Example:
        >>> df = post_trading_order_resv(cano="81180744", acnt_prdt_cd="01", pdno="005930", ord_qty="1", ord_unpr="55000", sll_buy_dvsn_cd="02", ord_dvsn_cd="00", ord_objt_cblc_dvsn_cd="10")
        >>> print(df)
    """
