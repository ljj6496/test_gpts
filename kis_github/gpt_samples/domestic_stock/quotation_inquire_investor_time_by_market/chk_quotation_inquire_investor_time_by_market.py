...
from quotation_inquire_investor_time_by_market import get_quotation_inquire_investor_time_by_market
...
def main():
    ...
    try:
        result = get_quotation_inquire_investor_time_by_market(fid_input_iscd="999", fid_input_iscd_2="S001")
