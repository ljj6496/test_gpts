...
import ranking_exp_trans_updown
...
def main():
    ...
    Example:
        >>> df = get_ranking_exp_trans_updown(fid_rank_sort_cls_code="0", fid_cond_mrkt_div_code="J", fid_cond_scr_div_code="20182", fid_input_iscd="0000", fid_div_cls_code="0", fid_aply_rang_prc_1="", fid_vol_cnt="", fid_pbmn="", fid_blng_cls_code="0", fid_mkop_cls_code="0")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = ranking_exp_trans_updown.get_ranking_exp_trans_updown(
