...
from quotation_nav_comparison_trend import get_quotation_nav_comparison_trend
...
def main():
    ...
    try:
        result1, result2 = get_quotation_nav_comparison_trend(fid_cond_mrkt_div_code="J", fid_input_iscd="069500")
    ...
    # 숫자형 컬럼 소수점 둘째자리까지 표시 (메타데이터에 number 타입이 명시되지 않아 빈 리스트)
    numeric_columns = []
