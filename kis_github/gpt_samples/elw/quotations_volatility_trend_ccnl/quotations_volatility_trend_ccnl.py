...
def get_quotations_volatility_trend_ccnl(
    ...
    Example:
        >>> df = get_quotations_volatility_trend_ccnl("W", "58J297")
        >>> print(df)
    """
    # 로깅 설정
    logger = logging.getLogger(__name__)
    ...
    if res.isOK():
        ...
        if tr_cont == "M":
            ...
            time.sleep(0.1)
            return get_quotations_volatility_trend_ccnl(
