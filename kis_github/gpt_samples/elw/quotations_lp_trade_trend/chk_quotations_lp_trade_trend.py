...
import quotations_lp_trade_trend
...
def main():
    ...
    Example:
        >>> df1, df2 = get_quotations_lp_trade_trend(fid_cond_mrkt_div_code="W", fid_input_iscd="52K577")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result1, result2 = quotations_lp_trade_trend.get_quotations_lp_trade_trend(
