...
def get_quotations_cond_search(
    ...
    # API 호출 정보 설정
    url = "/uapi/elw/v1/quotations/cond-search"  # API 엔드포인트
    tr_id = "FHKEW15100000"  # 거래 ID
    ...
    if res.isOK():
        ...
        if tr_cont == "M":
            ...
            return get_quotations_cond_search(
