...
import quotations_indicator_trend_daily
...
def main():
    ...
    Example:
        >>> df = get_quotations_indicator_trend_daily(fid_cond_mrkt_div_code="W", fid_input_iscd="57K281")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = quotations_indicator_trend_daily.get_quotations_indicator_trend_daily(
