...
import quotations_compare_stocks
...
def main():
    ...
    Example:
        >>> df = get_quotations_compare_stocks(fid_cond_scr_div_code="11517", fid_input_iscd="005930")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = quotations_compare_stocks.get_quotations_compare_stocks(
