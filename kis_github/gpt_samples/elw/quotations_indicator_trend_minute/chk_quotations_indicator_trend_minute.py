...
import quotations_indicator_trend_minute
...
def main():
    ...
    Example:
        >>> df = get_quotations_indicator_trend_minute(fid_cond_mrkt_div_code="W", fid_input_iscd="58J297", fid_hour_cls_code="60", fid_pw_data_incu_yn="N")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        # API 호출
        logger.info("API 호출 시작: ELW 투자지표추이(분별)")
        result = quotations_indicator_trend_minute.get_quotations_indicator_trend_minute(
