...
import quotations_expiration_stocks
...
def main():
    ...
    Example:
        >>> df = get_quotations_expiration_stocks(fid_cond_mrkt_div_code="W", fid_cond_scr_div_code="11547", fid_input_date_1="20240402", fid_input_date_2="20240408", fid_div_cls_code="2", fid_etc_cls_code="", fid_unas_input_iscd="000000", fid_input_iscd_2="00000", fid_blng_cls_code="0", fid_input_option_1="")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = quotations_expiration_stocks.get_quotations_expiration_stocks(
