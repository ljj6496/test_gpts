...
import quotations_newly_listed
...
def main():
    ...
    Example:
        >>> df = get_quotations_newly_listed(fid_cond_mrkt_div_code="W", fid_cond_scr_div_code="11548", fid_div_cls_code="02", fid_unas_input_iscd="000000", fid_input_iscd_2="00003", fid_input_date_1="20240402", fid_blng_cls_code="0")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = quotations_newly_listed.get_quotations_newly_listed(
