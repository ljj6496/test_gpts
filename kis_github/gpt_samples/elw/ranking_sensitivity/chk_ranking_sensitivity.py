...
def main():
    ...
    Example:
        >>> df = get_ranking_sensitivity(fid_cond_mrkt_div_code="W", fid_cond_scr_div_code="20285", fid_unas_input_iscd="000000", fid_input_iscd="00000", fid_div_cls_code="0", fid_input_price_1="", fid_input_price_2="", fid_input_vol_1="", fid_input_vol_2="", fid_rank_sort_cls_code="0", fid_input_rmnn_dynu_1="", fid_input_date_1="", fid_blng_cls_code="0")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = ranking_sensitivity.get_ranking_sensitivity(
