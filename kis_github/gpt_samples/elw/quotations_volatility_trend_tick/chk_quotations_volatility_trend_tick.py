...
import quotations_volatility_trend_tick
...
def main():
    ...
    Example:
        >>> df = get_quotations_volatility_trend_tick(fid_cond_mrkt_div_code="W", fid_input_iscd="58J297")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = quotations_volatility_trend_tick.get_quotations_volatility_trend_tick(
