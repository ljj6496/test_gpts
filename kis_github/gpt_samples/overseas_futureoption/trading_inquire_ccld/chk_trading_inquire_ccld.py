...
def main():
    ...
    Example:
        >>> df = get_trading_inquire_ccld(cano=trenv.my_acct, acnt_prdt_cd="01", ccld_nccs_dvsn="01", sll_buy_dvsn_cd="%%", fuop_dvsn="", ctx_area_fk200="", ctx_area_nk200="")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = trading_inquire_ccld.get_trading_inquire_ccld(
            cano=cano,  # 종합계좌번호
