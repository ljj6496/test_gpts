...
def get_quotations_inquire_time_futurechartprice(
    srs_cd: str,  # 종목코드
    exch_cd: str,  # 거래소코드
    ...
    Example:
        >>> df1, df2 = get_quotations_inquire_time_futurechartprice(
        ...     srs_cd="BONU25",
        ...     exch_cd="EUREX",
        ...     start_date_time="",
    ...
    if res.isOK():
        ...
        if tr_cont in ["M", "F"]:
            ...
            time.sleep(0.1)
            return get_quotations_inquire_time_futurechartprice(
                srs_cd,
                exch_cd,
                start_date_time,
                close_date_time,
