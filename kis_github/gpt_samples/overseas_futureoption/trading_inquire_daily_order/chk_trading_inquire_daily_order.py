...
import trading_inquire_daily_order
...
def main():
    ...
    Example:
        >>> df = get_trading_inquire_daily_order(cano=trenv.my_acct, acnt_prdt_cd="08", strt_dt="20250601", end_dt="20250703", fm_pdgr_cd="", ccld_nccs_dvsn="01", sll_buy_dvsn_cd="%%", fuop_dvsn="00", ctx_area_fk200="", ctx_area_nk200="")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = trading_inquire_daily_order.get_trading_inquire_daily_order(
            cano=cano,  # 종합계좌번호
