...
import trading_inquire_period_ccld
...
def main():
    ...
    Example:
        >>> df1, df2 = get_trading_inquire_period_ccld(inqr_term_from_dt="20250601", inqr_term_to_dt="20250630", cano=trenv.my_acct, acnt_prdt_cd="08", crcy_cd="%%%", whol_trsl_yn="N", fuop_dvsn="00", ctx_area_fk200="", ctx_area_nk200="")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result1, result2 = trading_inquire_period_ccld.get_trading_inquire_period_ccld(
