...
def main():
    ...
    Example:
        >>> df = get_trading_inquire_unpd(cano=trenv.my_acct, acnt_prdt_cd="08", fuop_dvsn="00", ctx_area_fk100="", ctx_area_nk100="")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = trading_inquire_unpd.get_trading_inquire_unpd(
            cano=cano,  # 종합계좌번호
