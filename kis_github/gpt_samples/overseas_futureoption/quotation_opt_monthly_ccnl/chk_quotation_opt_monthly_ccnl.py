...
from quotation_opt_monthly_ccnl import get_quotation_opt_monthly_ccnl
...
def main():
    ...
    try:
        result1, result2 = get_quotation_opt_monthly_ccnl(srs_cd="DXM24", exch_cd="ICE", qry_cnt="30")
