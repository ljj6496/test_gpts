...
import quotations_stock_detail
...
def main():
    ...
    Example:
        >>> df = get_quotations_stock_detail(srs_cd="BONU25")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        # API 호출
        logger.info("API 호출 시작: 해외선물종목상세")
        result = quotations_stock_detail.get_quotations_stock_detail(
            srs_cd=srs_cd,  # 종목코드
        )
