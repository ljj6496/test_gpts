...
def main():
    ...
    Example:
        >>> df = get_trading_margin_detail(cano=trenv.my_acct, acnt_prdt_cd="", crcy_cd="", inqr_dt="")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = trading_margin_detail.get_trading_margin_detail(
            cano=cano,  # 종합계좌번호
