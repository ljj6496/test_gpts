...
def get_quotation_inquire_time_optchartprice(
    srs_cd: str,  # 종목코드
    exch_cd: str,  # 거래소코드
    qry_cnt: str,  # 요청개수
    ...
    Example:
        >>> df1, df2 = get_quotation_inquire_time_optchartprice("OESU24 C5500", "CME", "20")
        >>> print(df1)
        >>> print(df2)
    """
    ...
    if res.isOK():
        ...
        if tr_cont in ["M", "F"]:  # 다음 페이지 존재
            ...
            return get_quotation_inquire_time_optchartprice(
