...
from quotation_inquire_time_optchartprice import get_quotation_inquire_time_optchartprice
...
def main():
    ...
    try:
        result1, result2 = get_quotation_inquire_time_optchartprice(srs_cd="DXM24", exch_cd="ICE", qry_cnt="30")
