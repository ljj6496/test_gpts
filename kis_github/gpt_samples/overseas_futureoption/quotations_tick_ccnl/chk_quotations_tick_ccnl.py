...
def main():
    ...
    Example:
        >>> df1, df2 = get_quotations_tick_ccnl(srs_cd="BONU25", exch_cd="EUREX", start_date_time="", close_date_time="20250630", qry_tp="Q", qry_cnt="30", qry_gap="", index_key="")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        # API 호출
        logger.info("API 호출 시작: 해외선물 체결추이(틱)")
        result1, result2 = quotations_tick_ccnl.get_quotations_tick_ccnl(
            srs_cd=srs_cd,  # 종목코드
