...
import trading_inquire_deposit
...
def main():
    ...
    Example:
        >>> df = get_trading_inquire_deposit(cano=trenv.my_acct, acnt_prdt_cd="08", crcy_cd="TUS", inqr_dt="20250630")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = trading_inquire_deposit.get_trading_inquire_deposit(
            cano=cano,  # 종합계좌번호
