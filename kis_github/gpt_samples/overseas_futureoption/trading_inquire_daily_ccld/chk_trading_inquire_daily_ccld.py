...
def main():
    ...
    Example:
        >>> df1, df2 = get_trading_inquire_daily_ccld(cano=trenv.my_acct, acnt_prdt_cd="01", strt_dt="20250101", end_dt="20250131", fuop_dvsn_cd="", fm_pdgr_cd="", crcy_cd="%%%", fm_item_ftng_yn="N", sll_buy_dvsn_cd="%%", ctx_area_fk200="", ctx_area_nk200="")
    """
    try:
        # pandas 출력 옵션 설정
