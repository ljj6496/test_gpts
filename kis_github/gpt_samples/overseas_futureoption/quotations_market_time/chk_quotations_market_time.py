...
def main():
    ...
    Example:
        >>> df = get_quotations_market_time(fm_pdgr_cd="", fm_clas_cd="", fm_excg_cd="CME", opt_yn="", ctx_area_nk200="", ctx_area_fk200="")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result = quotations_market_time.get_quotations_market_time(
