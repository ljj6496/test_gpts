...
import quotations_investor_unpd_trend
...
def main():
    ...
    Example:
        >>> df1, df2 = get_quotations_investor_unpd_trend(prod_iscd="GE", bsop_date="20240513", upmu_gubun="0", cts_key="")
    """
    try:
        # pandas 출력 옵션 설정
        ...
        result1, result2 = quotations_investor_unpd_trend.get_quotations_investor_unpd_trend(
